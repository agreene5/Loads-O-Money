...
var Coin_Variant = 2  # Determines the coin variant the user has | 0: Penny, 1: Nickel, 2: Dime, 3: Quarter
...
func calculate_difference(broadcast_value, received_value):
	return received_value - broadcast_value
